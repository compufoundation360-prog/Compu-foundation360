 ...
 * It handles the "Suspense" state, showing a nice loading spinner while the 
 * heavy simulator code is being downloaded by the browser.
 * 
 * Usage:
 * const MySim = lazy(() => import('@/simulators/MySim'));
 * 
 * <SimulatorWrapper>
 *   <MySim />
 * </SimulatorWrapper>
